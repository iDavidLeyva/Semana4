...
public class MainActivity extends AppCompatActivity {
    ...
    public void inicializarListaMascotas(){
        ...
        Mascota mascota1 = new Mascota("Alfredo", 0, R.drawable.masc1);
        mascotas.add(mascota1);
        Mascota mascota2 = new Mascota("Sofia", 0, R.drawable.masc2);
        mascotas.add(mascota2);
        Mascota mascota3 = new Mascota("Peter", 0, R.drawable.masc3);
        mascotas.add(mascota3);
        Mascota mascota4 = new Mascota("Nia", 0, R.drawable.masc4);
        mascotas.add(mascota4);
        Mascota mascota5 = new Mascota("Lopez", 0, R.drawable.masc5);
